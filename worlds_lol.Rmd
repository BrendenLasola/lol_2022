...
For num_banned and num_picked,I want to make a bar graph that has the champion PNG + the amount of stuff that is going there. 
```{r}
red <-ggplot(data=num_banned, aes(x=banned, y=n)) +
